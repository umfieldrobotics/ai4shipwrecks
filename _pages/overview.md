...
If part of the ship is obscured in an acoustic shadow, the label was extrapolated into the shadowed region to follow the true shape of the wreck based off of expert knowledge and cross-referenced sonar images from other angles.
